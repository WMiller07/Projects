...
SELECT 
	...
	--Suggested offer adjustments
	bty.total_SuggestedOfferAdjustedItems - bly.total_SuggestedOfferAdjustedItems [diff_total_SuggestedOfferAdjustedItems],
	bty.total_SuggestedOfferAdjustedItems_Up - bly.total_SuggestedOfferAdjustedItems_Up [diff_total_SuggestedOfferAdjustedItems_Up],
	bty.total_SuggestedOfferAdjustedItems_Down - bly.total_SuggestedOfferAdjustedItems_Down [diff_total_SuggestedOfferAdjustedItems_Down],
	bty.total_SuggestedOfferAdjustedOffers - bly.total_SuggestedOfferAdjustedOffers [diff_total_SuggestedOfferAdjustedOffers],
	bty.total_SuggestedOfferAdjustedOffers_Up - bly.total_SuggestedOfferAdjustedOffers_Up [diff_total_SuggestedOfferAdjustedOffers_Up],
	bty.total_SuggestedOfferAdjustedOffers_Down - bly.total_SuggestedOfferAdjustedOffers_Down [diff_total_SuggestedOfferAdjustedOffers_Down],
	--Chain versus location offers plus adjustments
	bty.count_SuggestedOfferChain - bly.count_SuggestedOfferChain [diff_count_SuggestedOfferChain],
	bty.count_SuggestedOfferLoc - bly.count_SuggestedOfferLoc [diff_count_SuggestedOfferLoc],
	bty.count_SuggestedOfferChainAdj - bly.count_SuggestedOfferChainAdj [diff_count_SuggestedOfferChainAdj],
	bty.count_SuggestedOfferLocAdj - bly.count_SuggestedOfferLocAdj [diff_count_SuggestedOfferLocAdj],
	--Offers of $0.00 from chain and location tables
	bty.total_ZeroSuggestedOfferItems - bly.total_ZeroSuggestedOfferItems [diff_total_ZeroSuggestedOfferItems],
	bty.count_SuggestedOfferChainZero - bly.count_SuggestedOfferChainZero [diff_count_SuggestedOfferChainZero],
	bty.count_SuggestedOfferLocZero - bly.count_SuggestedOfferLocZero [diff_count_SuggestedOfferLocZero]
...
SELECT 
	...
	--Chain averages
	AVG(AVG(bmt.count_BuyTransactions)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_BuyTransactions],
	AVG(AVG(bmt.total_BuyOffers)) OVER (
	...
	AVG(AVG(bmt.total_BuyWait_Sec)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_BuyWait_Sec],
		--Suggested offer adjustments
	...
	AVG(AVG(bmt.count_SuggestedOfferChain)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferChain],
	AVG(AVG(bmt.count_SuggestedOfferLoc)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferLoc],
	...
	AVG(AVG(bmd.diff_count_BuyTransactions)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_BuyTransactions],
	AVG(AVG(bmd.diff_total_BuyOffers)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_BuyOffers],
	AVG(AVG(bmd.diff_total_BuyItems)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_BuyItems],
	AVG(AVG(bmd.diff_total_ScannedQuantity)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_ScannedQuantity],
	AVG(AVG(bmd.diff_total_ScannedOffers)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_ScannedOffers],
	AVG(AVG(bmd.diff_total_SuggestedOfferQuantity)) 
		OVER (ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferQuantity],
	AVG(AVG(bmd.diff_total_SuggestedOffers)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOffers],
	AVG(AVG(bmd.diff_total_BuyWait_Sec)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_BuyWait_Sec],
		--Suggested offer adjustments
	AVG(AVG(bmd.diff_total_SuggestedOfferAdjustedItems)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedItems],
	AVG(AVG(bmd.diff_total_SuggestedOfferAdjustedItems_Up)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedItems_Up],
	AVG(AVG(bmd.diff_total_SuggestedOfferAdjustedItems_Down)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedItems_Down],
	AVG(AVG(bmd.diff_total_SuggestedOfferAdjustedOffers)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedOffers],
	AVG(AVG(bmd.diff_total_SuggestedOfferAdjustedOffers_Up)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedOffers_Up],
	AVG(AVG(bmd.diff_total_SuggestedOfferAdjustedOffers_Down)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedOffers_Down],
	--Chain versus location offers plus adjustments
	AVG(AVG(bmd.diff_count_SuggestedOfferChain)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferChain],
	AVG(AVG(bmd.diff_count_SuggestedOfferLoc)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferLoc],
	AVG(AVG(bmd.diff_count_SuggestedOfferChainAdj)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferChainAdj],
	AVG(AVG(bmd.diff_count_SuggestedOfferLocAdj)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferLocAdj],
	--Offers of $0.00 from chain and location tables
	AVG(AVG(bmd.diff_total_ZeroSuggestedOfferItems)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_ZeroSuggestedOfferItems],
	AVG(AVG(bmd.diff_count_SuggestedOfferChainZero)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferChainZero],
	AVG(AVG(bmd.diff_count_SuggestedOfferLocZero)) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferLocZero]
...
SELECT 
	...
	bmt.total_BuyOffers [total_BuyOffers],
	...
	bmt.total_BuyWait_Sec [total_BuyWait_Sec],
	--Suggested offer adjustments
	...
	--Chain averages
	AVG(bmt.count_BuyTransactions) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_BuyTransactions],
	AVG(bmt.total_BuyOffers) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_BuyOffers],
	AVG(bmt.total_BuyItems) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_BuyItems],
	AVG(bmt.total_ScannedQuantity) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_ScannedQuantity],
	AVG(bmt.total_ScannedOffers) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_ScannedOffers],
	AVG(bmt.total_SuggestedOfferQuantity) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferQuantity],
	AVG(bmt.total_SuggestedOfferAmount) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOffers],
	AVG(bmt.total_BuyWait_Sec) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_BuyWait_Sec],
		--Suggested offer adjustments
	AVG(bmt.total_SuggestedOfferAdjustedItems) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferAdjustedItems],
	AVG(bmt.total_SuggestedOfferAdjustedItems_Up) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferAdjustedItems_Up],
	AVG(bmt.total_SuggestedOfferAdjustedItems_Down) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferAdjustedItems_Down],
	AVG(bmt.total_SuggestedOfferAdjustedOffers) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferAdjustedOffers],
	AVG(bmt.total_SuggestedOfferAdjustedOffers_Up) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferAdjustedOffers_Up],
	AVG(bmt.total_SuggestedOfferAdjustedOffers_Down) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferAdjustedOffers_Down],
	--Chain versus location offers plus adjustments
	AVG(bmt.count_SuggestedOfferChain) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferChain],
	AVG(bmt.count_SuggestedOfferLoc) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferLoc],
	AVG(bmt.count_SuggestedOfferChainAdj) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferChainAdj],
	AVG(bmt.count_SuggestedOfferLocAdj) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferLocAdj],
	--Offers of $0.00 from chain and location tables
	AVG(bmt.total_ZeroSuggestedOfferItems) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_ZeroSuggestedOfferItems],
	AVG(bmt.count_SuggestedOfferChainZero) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferChainZero],
	AVG(bmt.count_SuggestedOfferLocZero) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [rollavg_SuggestedOfferLocZero],
	--Chain average differences from last year
	AVG(bmd.diff_count_BuyTransactions) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_BuyTransactions],
	AVG(bmd.diff_total_BuyOffers) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_BuyOffers],
	AVG(bmd.diff_total_BuyItems) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_BuyItems],
	AVG(bmd.diff_total_ScannedQuantity) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_ScannedQuantity],
	AVG(bmd.diff_total_ScannedOffers) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_ScannedOffers],
	AVG(bmd.diff_total_SuggestedOfferQuantity) 
		OVER (ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferQuantity],
	AVG(bmd.diff_total_SuggestedOffers) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOffers],
	AVG(bmd.diff_total_BuyWait_Sec) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_BuyWait_Sec],
		--Suggested offer adjustments
	AVG(bmd.diff_total_SuggestedOfferAdjustedItems) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedItems],
	AVG(bmd.diff_total_SuggestedOfferAdjustedItems_Up) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedItems_Up],
	AVG(bmd.diff_total_SuggestedOfferAdjustedItems_Down) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedItems_Down],
	AVG(bmd.diff_total_SuggestedOfferAdjustedOffers) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedOffers],
	AVG(bmd.diff_total_SuggestedOfferAdjustedOffers_Up) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedOffers_Up],
	AVG(bmd.diff_total_SuggestedOfferAdjustedOffers_Down) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferAdjustedOffers_Down],
	--Chain versus location offers plus adjustments
	AVG(bmd.diff_count_SuggestedOfferChain) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferChain],
	AVG(bmd.diff_count_SuggestedOfferLoc) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferLoc],
	AVG(bmd.diff_count_SuggestedOfferChainAdj) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferChainAdj],
	AVG(bmd.diff_count_SuggestedOfferLocAdj) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferLocAdj],
	--Offers of $0.00 from chain and location tables
	AVG(bmd.diff_total_ZeroSuggestedOfferItems) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_ZeroSuggestedOfferItems],
	AVG(bmd.diff_count_SuggestedOfferChainZero) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferChainZero],
	AVG(bmd.diff_count_SuggestedOfferLocZero) OVER (
		ORDER BY bmt.BusinessDate ROWS BETWEEN 27 PRECEDING AND CURRENT ROW) [diff_avg_SuggestedOfferLocZero]
FROM #BuyMetrics_TY bmt
	INNER JOIN #BuyMetrics_Diff bmd
		ON	bmt.BusinessDate = bmd.BusinessDate 
